...
三维模型首版现已提供：[Blender／GLB、尺寸配置及检查报告](model3d/README.md)。保留七个相机，默认仅后台建模和验证；餐椅与厨房玻璃、南墙设备操作空间的冲突已列为待调整项。

![R10.1平面](deliverables/preview-furniture.png)

- [33页离线方案册](deliverables/方案册.html)
...
- [机器人基站核验](deliverables/14-robot-station-review.svg)
- [岛桌连接](deliverables/15-island-table-connection.svg)
