...
def family_drawings():
 ...
 for i,t in enumerate(['鞋柜关闭，家庭厅子母门全开','相关房门按90°固定状态计算','600方篮，额外10／侧复核','三条路径均无概念实体命中','A门把手87–90°碰原西墙','A路线条件未最终解除','须复核实物把手和开启限位','不移动门洞来规避问题']):txt(q,940,370+i*46,t,16)
